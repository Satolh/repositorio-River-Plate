...
import gameDetails from "../copaArgentina/copaArgentinaGames.json"
...
const DatoPartidosCopaArgentina = () => {

  const [detailsGameSelected, setDetailsGameSelected] = useState([]);
  const [yearArgentina, setYearArgentina] = useState(null)
    ...
    <section className='container-dato-partido'>
      ...
      { detailsGameSelected[0] &&
        <div className='container-all-games'>
            <h1 className='title-partido'>{`Copa Argentina ${yearArgentina}`}</h1>
...
export default DatoPartidosCopaArgentina;